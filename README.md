...
| `discovery-schema.json` | Canonical schema for `proposals/<slug>/discovery.json` — what the discovery interview captures, including theme choice and transcript sources |
